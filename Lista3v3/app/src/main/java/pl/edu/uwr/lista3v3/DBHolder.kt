...
import pl.edu.uwr.lista3v3.TabelaList
...
class DBHandler(context: Context) : SQLiteOpenHelper(
    ...
    fun addElement(element: TabelaList){
    ...
    fun getElement(num: Int): List<TabelaList> {
        val endlist: MutableList<TabelaList> = ArrayList()
    ...
    fun getElementtt(num: Int): List<TabelaList> {
        val endlist: MutableList<TabelaList> = ArrayList()
...
try{
    ...
    fun addToGallery(singleItem: TabelaList): Long{
        val db = this.writableDatabase
